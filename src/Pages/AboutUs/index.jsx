...
function AboutUs() {
  ...
  return (
    <Layout>
      <AboutHero
        mt={true}
        text="At ELAXS Solutions, we are dedicated to transforming businesses through the power of ServiceNow. As a ServiceNow consulting firm, we specialize in providing cutting-edge solutions that streamline operations, enhance efficiency, 
