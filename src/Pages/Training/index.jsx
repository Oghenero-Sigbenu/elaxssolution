          ...
          `}
            >
              ...
              <p className={`mt-[1rem] mb-[1.5rem] text-[1rem] leading-7 `}>
                At ELAXS Solutions, our commitment to your organization's
          ...
          <div className="flex flex-wrap  mt-[3rem] max-w-[90%] lg:max-w-[85%] mx-auto ">
            ...
            <div className="flex mt-[3rem] bg-transparent flex-wrap  gap-[1.5rem]">
              <AnimatePresence>
                ...
                >
                  ...
                  <p>
                    Theory only goes so far; practical application is key. ELAXS
                ...
                >
                  ...
                  <p>
                    As your organization evolves, so do your needs. ELAXS
            ...
            <div className="text-center w-full mx-auto md:w-[70%] mt-[8rem] mb-[rem]">
              <p className="text-[1.5rem]">
                "Training and support by ELAXS Solutions isn't just a service;
