        ...
        `}
            >
              ...
              <p className={`mt-[1rem] mb-[1.5rem] text-[1rem] leading-7 `}>
                At ELAXS Solutions, our commitment to process optimization is at
          ...
          <div className="flex flex-wrap  mt-[3rem] max-w-[90%] lg:max-w-[85%] mx-auto ">
            ...
            <div className="flex mt-[3rem] gap-[1.5rem] bg-transparent flex-wrap ">
              <AnimatePresence>
                ...
                >
                  ...
                  <p>
                    ELAXS Solutions understands that every organization has
                ...
                >
                  ...
                  <p>
                    ...
                    involves improved collaboration and communication. ELAXS
                ...
                >
                  ...
                  <p>
                    Process optimization is an ongoing journey. ELAXS Solutions
            ...
            <div className="text-center w-full mx-auto md:w-[70%] mt-[8rem] mb-[rem]">
              <p className="text-[1.5rem]">
                ...
                ELAXS Solutions. Our ServiceNow implementation doesn't stop at
