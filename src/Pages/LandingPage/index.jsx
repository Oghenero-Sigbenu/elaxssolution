...
function LandingPage({ baseVelocity = 10 }) {
  ...
  return (
    <Layout color={true} className="">
      ...
      <div className="">
        <AboutHero
          text="ELAXS is a leading boutique ServiceNow consulting and training company based in Ajax, ON. Our team of experts is dedicated to providing exceptional services to our clients, helping them to optimize their ServiceNow platform and achieve their business goals."
        ...
        <div className=" mt-[8rem] mb-[5rem] md:mt-[8rem] md:mb-[7rem]">
          ...
          <p className="text-center mt-[1rem] mx-auto w-[90%] md:w-[50%]">
            ELAXS Solution Incoporate Inc. provides ServiceNow consulting and
