      ...
      <div className="w-full  ">
          ...
          `}
            >
              ...
              <p className={`mt-[1rem] mb-[1.5rem] text-[1rem] leading-7 `}>
                ServiceNow implementation by ELAXS Solutions isn't just about
              ...
              <p>
                At ELAXS Solutions, we understand that successful ServiceNow
        ...
        <div className="w-full   bg-  mb-[4rem] pt-[3rem]">
          <div className="flex flex-wrap  mt-[3rem] max-w-[90%] lg:max-w-[85%] mx-auto ">
            <Title
              text="text-primary"
              title="Why Choose ELAXS Solutions?"
              bg="bg"
              ...
              <AnimatePresence>
                ...
                >
                  ...
                  <p>
                    ...
                    complex task. ELAXS Solutions ensures a seamless data
                ...
                >
                  ...
                  <p>
                    ...
                    involves your people. ELAXS Solutions provides comprehensive
